...
class TechnicalSignals:
    ...
    def duration(self) -> float:
        ...
        return float(self.mkvmerge.get('container', {}).get('properties', {}).get('duration', 0)) / 1_000_000_000
    ...
    def estimated_episode_count(self) -> int:
        ...
        if self.duration_minutes > 150: return 6
        if self.duration_minutes > 100: return 4
        if self.duration_minutes > 70: return 3
        if self.duration_minutes > 40: return 2
        return 1
    ...
    def suggested_ocr_ranges(self) -> List[Tuple[float, float]]:
        ...
        if self.is_multi_episode:
             ...
             for chap in self.chapters:
                 start_ms = float(chap.get('num_entries', 0)) # wait, mkvmerge -J chapter format?
                 ...
                 if start_ns:
                     ...
                     if 300 < start_sec < (duration - 300): # Avoid start/end already covered
